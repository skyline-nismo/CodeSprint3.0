...
| :-: | -------------------------------------------- | -------------- | ---------------- | --------------- | ------------------- | :-------: | :------: | :--------: |
|  1  | 🎉 Shristi and the College Fest Announcement | [Q1.md](Q1.md) | [Q1.cpp](Q1.cpp) | Strings         | Character Traversal |  **O(n)** | **O(1)** |   🟢 Easy  |
|  2  | 🛡️ Souvik's Firewall Pattern                | [Q2.md](Q2.md) | [Q2.cpp](Q2.cpp) | Patterns, Loops | Simulation          | **O(n²)** | **O(1)** |   🟢 Easy  |
